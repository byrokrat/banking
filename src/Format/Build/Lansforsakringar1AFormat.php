 ...
 */
class Lansforsakringar1AFormat implements \byrokrat\banking\Format\FormatInterface
{
    ...
    {
        return new \byrokrat\banking\Validator\ClearingValidator([[3400, 3409], [9060, 9069]]);
    }
